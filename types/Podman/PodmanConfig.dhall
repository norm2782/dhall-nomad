...
let MountConfig = (./PodmanConfigMount.dhall).Type

in  { image : Text
    , image_pull_timeout : Optional Text
    , args : Optional (List Text)
    , auth : Optional ./PodmanAuth.dhall
    ...
    , network_mode : Optional ./PodmanNetworkMode.dhall
    , pid_mode : Optional ./PodmanPIDMode.dhall
    ...
    , tty : Optional Bool
    , uts_mode : Optional ./PodmanPIDMode.dhall
    , userns_mode : Optional ./PodmanPIDMode.dhall
    , volumes : Optional (List Text)
    , volume_driver : Optional Text
    , work_dir : Optional Text
    , mounts : Optional (List MountConfig)
    , devices : Optional (List ./PodmanDevice.dhall)
